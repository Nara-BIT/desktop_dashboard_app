...
* **IPC (Inter-Process Communication):** A secure messaging system that allows the **Renderer** (UI) and the **Main** (System) processes to talk to each other. For example, it sends login credentials from the UI to the system for validation.
